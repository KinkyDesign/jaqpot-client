...
import jaqpot.client.auth.Authentication;
import jaqpot.client.auth.HttpBasicAuth;
import jaqpot.client.auth.ApiKeyAuth;
import jaqpot.client.auth.OAuth;
...
public class ApiClient {
    ...
    private String basePath = "http://test.jaqpot.org:8081/jaqpot/services";
    ...
    public ApiClient() {
        ...
        authentications.put("subjectid", new ApiKeyAuth("header", "subjectid"));
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g http://test.jaqpot.org:8081/jaqpot/services
